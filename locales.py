...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "it": {
        ...
        "reg_confirm_subject": "Conferma il tuo indirizzo",
        "reg_confirm_body": "Apri questo link per confermare il tuo indirizzo. Serve per poter chiedere l'accesso alle app.",
    ...
    "en": {
        ...
        "reg_confirm_subject": "Confirm your address",
        "reg_confirm_body": "Open this link to confirm your address. You need it before you can request access to any tool.",
    ...
    "de": {
        ...
        "reg_confirm_subject": "Bestätigen Sie Ihre Adresse",
        "reg_confirm_body": "Öffnen Sie diesen Link, um Ihre Adresse zu bestätigen. Sie brauchen das, bevor Sie Zugang zu einem Werkzeug beantragen können.",
    ...
    "fr": {
        ...
        "reg_confirm_subject": "Confirmez votre adresse",
        "reg_confirm_body": "Ouvrez ce lien pour confirmer votre adresse. Elle est nécessaire avant de pouvoir demander l'accès à un outil.",
        ...
        "req_sent_body": "Un administrateur la verra et décidera. Vous recevrez un courriel une fois fait.",
